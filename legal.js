...
const I18N = {
  pl: {
    ...
    privacyIntro:
      "Pretty-Mails działa po stronie przeglądarki. Dane wpisane w formularzu nie są wysyłane na serwer aplikacji.",
    privacyDataTitle: "Jakie dane mogą być przetwarzane:",
    privacyDataItem1: "treść wiadomości i pliki dodane przez użytkownika (lokalnie w przeglądarce),",
    ...
    privacyThirdParty:
      "Dane nie są przesyłane do naszych serwerów, nie są analizowane ani profilowane.",
    ...
    termsItem4: "Narzędzie działa lokalnie w przeglądarce; wysyłkę użytkownik wykonuje samodzielnie w swojej aplikacji pocztowej.",
  ...
  en: {
    ...
    privacyDataItem1: "message content and files added by the user (locally in the browser),",
    ...
    privacyThirdParty:
      "Data is not sent to our servers, and is not analyzed or profiled.",
    ...
    termsItem4: "The tool runs locally in the browser; sending is performed by the user in their own mail app.",
  ...
  uk: {
    ...
    privacyDataItem1: "вміст листа та файли, додані користувачем (локально в браузері),",
    ...
    privacyThirdParty:
      "Дані не передаються на наші сервери та не аналізуються.",
    ...
    termsItem4: "Інструмент працює локально в браузері; надсилання користувач виконує у власному поштовому застосунку.",
